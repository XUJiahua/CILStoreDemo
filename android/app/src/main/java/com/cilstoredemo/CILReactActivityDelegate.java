...
/**
 * copy自ReactActivityDelegate
 *
 * 由于很多方法是protected修饰，不在同一个包内的类无法访问protected方法
 * 另外新增一个元素
 */
 ...
 */
public class CILReactActivityDelegate {
    ...
    public CILReactActivityDelegate(
    ...
    /**
     * 新增 mReactNativeHost，不再从Application中获取
     */
